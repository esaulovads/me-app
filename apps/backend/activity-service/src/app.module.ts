...
@Module({
  ...
  controllers: [ExerciseController, WorkoutController, WorkoutExerciseController, SetController, MuscleGroupController, WorkoutScheduleController],
  providers: [ExerciseService, WorkoutService, WorkoutExerciseService, SetService, MuscleGroupService, WorkoutScheduleService],
})
